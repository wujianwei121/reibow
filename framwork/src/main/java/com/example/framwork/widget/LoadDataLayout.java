...
public class LoadDataLayout extends FrameLayout implements View.OnClickListener {
    ...
    public static class Builder {
        ...
        int noNetWorkImgId = R.drawable.ic_no_wifi;
        ...
        int allPageBackgroundColor = R.color.bg_grey;
        int allTipTextColor = R.color.text_color;
        int allTipTextSize = 16;
        int loadingTextSize = 16;
        int loadingTextColor = R.color.text_color;
        int reloadBtnTextSize = 16;
        int reloadBtnTextColor = R.color.text_color;
