...
/**
 * Created by wjw on 2017/6/12.
 * 可以设置圆角 圆形image 并添加点击效果
 */
public class ShapeImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    public void setBorderWidth(int borderWidth) {
        this.borderWidth = DensityUtil.getInstance().dip2px(getContext(), borderWidth);
        invalidate();
    }
    ...
    public void setRadius(int radius) {
        this.radius = DensityUtil.getInstance().dip2px(getContext(), radius);
        invalidate();
    }
