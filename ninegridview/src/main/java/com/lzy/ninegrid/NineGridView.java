...
public class NineGridView extends ViewGroup {
    ...
    private int singleImageHeight = 250;
    ...
    public NineGridView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        singleImageHeight = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, singleImageHeight, dm);
        ...
        singleImageHeight = a.getDimensionPixelSize(R.styleable.NineGridView_ngv_singleImageHeight, singleImageHeight);
